...
>
> The research this project produces is published on the author's blog, **[Research Notes](https://ia64mail.github.io/)**. Start with **[Ticket-Driven Development in an Agentic World](https://ia64mail.github.io/quorum/ticket-driven-development-in-an-agentic-world/)** for the methodology — the *why* behind this system. The remainder of this README describes the system that emerged from these experiments.
