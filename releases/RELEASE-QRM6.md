...
> **Note (ticket #50):** this report was generated by the entropy-report lexer *before* the Halstead-correctness fix. The absolute Volume, Difficulty, and per-app figures quoted below are systematically biased — trend direction holds, but treat the numbers as indicative only. The corrected baseline is `tools/entropy-report/reports/entropy-20260530-013740.html`.
