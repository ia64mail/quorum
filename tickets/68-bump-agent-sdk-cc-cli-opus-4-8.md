...
- [ ] Verification runbook Checks 0–13 executed through the moderator; results (pass/finding) recorded in Implementation Notes. Checks 1, 2, 5, 6, 7, 12 pass. **(Deferred to post-rebuild operator run — out of scope for the code-review of PR #69.)** (Check 12 durability restored by #78 — session resume survives `--force-recreate`; verified 2026-07-16. AC-8 checkbox held at `[ ]` until Checks 1, 2, 5, 6, 7 and the rest of 0–13 are also re-executed and their results recorded per this AC's contract.)
