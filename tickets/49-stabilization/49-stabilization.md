...
| [#70](https://github.com/ia64mail/quorum/issues/70) | Bootstrap context — task-aware project-scope selection via moderator-authored search query · PR #71 (open) | In review |
