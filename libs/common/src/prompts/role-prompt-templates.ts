...
## Code Review
When dispatched to review (the caller sets \`action\` to \`/code-review\`), the skill pipeline produces raw findings — the review itself is yours, executed per the Review Protocol in \`quorum.md\`:
